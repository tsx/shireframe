...
convert /tmp/r.png \( +clone -channel G +noise Random -virtual-pixel Tile -blur 0x50 -auto-level -separate +channel \) -swap 0,1 -resize 70% miff:- | composite - -displace 5 /tmp/r.jpg
mv /tmp/r.jpg "$2"
